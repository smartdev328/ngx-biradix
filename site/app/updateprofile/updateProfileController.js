            ...
            var unbind = $rootScope.$watch("me", function(x) {
                if ($rootScope.me) {
                    ...
                    $scope.columnsItems = [
                        ...
                        {id: "nerweek", name: "NER vs Last Week", selected: $rootScope.me.settings.notification_columns.nerweek},
                        {id: "nermonth", name: "NER vs Last Month", selected: $rootScope.me.settings.notification_columns.nermonth},
                        {id: "neryear", name: "NER vs Last Year", selected: $rootScope.me.settings.notification_columns.neryear},
