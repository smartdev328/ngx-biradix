...
var SurveysCreate = function(users, properties, callback) {
    ...
    async.series([
        ...
        function(callbacks){
            ...
            surveys.push(getSurvey(date, properties.Test1, 75, 15, 9, rents));

            rents = [ 500, 0, 1000, 1000 ];
            surveys.push(getSurvey(date, properties.Test2, 90, 30, 10, rents));

            rents = [ 2000, 400, 200, 4000, 400, 400 ];
            surveys.push(getSurveyRecurring(date, properties.Test3, 60, 5, 2, rents));
        ...
        function(callbacks){
            ...
            surveys.push(getSurvey(date, properties.Test1, 50, 10, 3, rents));

            rents = [ 1000, 0, 2000, 1000 ];
            surveys.push(getSurvey(date, properties.Test2, 60, 20, 70, rents));

            rents = [ 3000, 1000, 1000, 6000, 1000, 2000 ];
            surveys.push(getSurveyRecurring(date, properties.Test3, 45, 8, 4, rents));
        ...
        function(callbacks){
            ...
            var dateTemp = moment().subtract(53,"week");

            var rents = [ 1000, 1000, 2000, 2000, 3000, 3000, 4000, 4000 ];
            surveys.push(getSurvey(dateTemp, properties.Test1, 25, 5, 1, rents));

            rents = [ 1500, 0, 3000, 0 ];
            surveys.push(getSurvey(dateTemp, properties.Test2, 30, 10, 5, rents));

            rents = [ 4000, 500, 500, 8000, 1000, 1000 ];
            surveys.push(getSurveyRecurring(dateTemp, properties.Test3, 30, 12, 6, rents));
