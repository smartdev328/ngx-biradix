...
import {IDataIntegrityCheck} from "../interfaces/IDataIntegrityCheck";

const DataIntegrityChecks: IDataIntegrityCheck[] = [
    {severity: DataIntegritySeverity.HIGH, type: DataIntegrityCheckType.PROPERTY_GEO_DUPLICATE, name: "New Property Proximity Alert", searchParameter: DataIntegritySearchParameter.PROPERTY},
